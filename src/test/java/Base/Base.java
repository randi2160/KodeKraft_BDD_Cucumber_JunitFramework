...
public class Base {
    ...
    public void setUp() {
        ...
        boolean useGrid = Boolean.parseBoolean(System.getProperty("useGrid", "false")); // Default to local execution
        ...
        if (useGrid) {
            ...
            // Running tests locally without Grid
            ...
            switch (browser.toLowerCase()) {
                case "firefox":
                    ...
                    driver = new FirefoxDriver(firefoxOptions); // Run locally
                    break;
                ...
                case "edge":
                    ...
                    driver = new EdgeDriver(edgeOptions); // Run locally
                    break;
                ...
                default:
                    ...
                    chromeOptions.addArguments("--disable-gpu");
                    chromeOptions.addArguments("--window-size=1920,1080");
                    driver = new ChromeDriver(chromeOptions); // Run locally
                    break;
            }
        }
    }
